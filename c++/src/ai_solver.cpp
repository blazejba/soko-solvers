...
int main(int argc, char *argv[])
{
    ...
    std::string problem_path = ("/home/blazejba/sokoban_solver/problems/problem" + std::string(argv[1]) + ".txt");
    std::string solution_path = ("/home/blazejba/sokoban_solver/solutions/solution" + std::string(argv[1]) + ".txt");
